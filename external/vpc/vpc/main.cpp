...
bool CVPC::Init( int argc, char **argv )
{
	...
	Log_Msg( LOG_VPC, "(C) Copyright 2020-2023 community on GitHub\n");
	Log_Msg( LOG_VPC, "\n" );
...
bool CVPC::CheckBinPath( char *pOutBinPath, int outBinPathSize )
{
	...
	Warning( "********************************************************************************\n" );
	Warning( "Wrong Executable '%s' Running!\nRestarting at '%s'\n", szModuleBinPath, pOutBinPath );
	Warning( "********************************************************************************\n" );
...
bool CVPC::BuildTargetProjects()
{
	...
	if ( !m_bGeneratedProject && !m_bAnyProjectQualified )
	{
		Warning( "\n" );
		Warning( "----------------------------\n" );
		Warning( "!!! No Project Generated !!!\n" );
		Warning( "----------------------------\n" );
		Warning( "\n" );
		Warning( "Possibly missing game, platform, or other conditional expected by script.\n" );
		Warning( "Use /h verify desired target build set.\n" );
...
void CVPC::SetupGenerators()
{
	...
	else
	{
		...
		else if ( IsPlatformDefined( "X360" ) )
		{
			...
			{
				Msg( "Generating for Visual Studio 2010.\n" );
